      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <div class="page-header">
            <h1><i class="fa fa-fw fa-user"></i> Editar empleado</h1>
          </div>
          <!-- TITULO -->
          <?php view::includePartial('empleado/formEdit', array('objEmpleado' => $objEmpleado, 'objTipoDocumento' => $objTipoDocumento)) ?>
        </div>
      </div>
    </div>
  </div>
