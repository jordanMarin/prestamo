...
<form class="form-horizontal ibody" role="form" method="POST" action="<?php echo routing::getInstance()->getUrlWeb('banco','createBanco') ?>">
  <fieldset>
    ...
    <div class="form-group <?php echo (session::getInstance()->hasFlash('inputBanco')) ? 'has-error has-feedback' : '' ?>">
      ...
      <div class="col-sm-10">
        <input value="<?php echo (request::getInstance()->hasPost('inputBanco')) ? request::getInstance()->getPost('inputBanco') : '' ?>" type="text" class="form-control" id="inputnombre" name="inputBanco" placeholder="digite el nombre">
    ...
    <div class="form-group text-right">
      <div class="col-sm-offset-2 col-sm-10">
        ...
        <a href="<?php echo routing::getInstance()->getUrlWeb('@banco_index') ?>" class="btn btn-default">Cancelar</a>
      </div>
    </div>
  </fieldset>
</form>
