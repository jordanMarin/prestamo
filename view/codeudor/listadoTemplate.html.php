      ...
      <div class="panel panel-default">
        <div class="panel-body">
          ...
          <div class="page-header">
            <h1><i class="fa fa-fw fa-users"></i>Codeudor</h1>
          </div>
          <!-- TITULO -->
          <!-- TABLA -->
          <div class="botonera">
            <a href="<?php echo routing::getInstance()->getUrlWeb('@codeudor_codeudor') ?>" class="btn btn-success btn-sm"><i class="fa fa-fw fa-plus"></i> Nuevo</a>
          </div>
