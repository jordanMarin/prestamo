...
config::setUrlBase('http://localhost/prestamo/web/');
...
config::setCookiePath('http://localhost/prestamo/web/' . config::getIndexFile());
config::setCookieDomain('http://localhost/prestamo/web/');
